...
<div class="col-lg-12">
  <div class="card">
    <div class="card-header">
      <div class="row">
        <div class="col">
          <i class="far fa-dot-circle mr-2"></i><?php echo _("Configure pipeline"); ?>
        </div>
        <div class="col">
    ...
    <?php $status->showMessages(); ?>
      <form role="form" action="?page=pipeline_conf" method="POST">
        ...
        <ul class="nav nav-tabs">
          <li class="nav-item"><a class="nav-link active" id="pipelinetab" href="#pipeline" aria-controls="pipeline" data-toggle="tab"><?php echo _("Pipeline"); ?></a></li>
          <li class="nav-item"><a class="nav-link" id="basictab" href="#basic" data-toggle="tab"><?php echo _("Basic"); ?></a></li>
        ...
        <div class="tab-content">
            ...
            <h4 class="mt-3"><?php echo _("Pipeline settings") ;?></h4>
            <div class="row">
